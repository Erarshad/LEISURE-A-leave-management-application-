...
class csed extends StatefulWidget {
  String myvar;
  csed({this.myvar});
  @override
  _csedState createState() => _csedState(myvar);
}

class _csedState extends State<csed> {
   String myvar;// faculty name 
  _csedState(this.myvar);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("C.S.E PANEL"),
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   //var firestore=Firestore.instance;
   QuerySnapshot qn= await firestore.collection('CSE').where("Approved by Hod",isEqualTo:"yes").getDocuments();
   return qn.documents;  
        ...
        Container(
           ...
           //Text("Application Submition Date: "+widget.post.data["Application submittion date"],style: TextStyle(fontSize: 25.0),),
            RichText(text:TextSpan(children:<TextSpan>[
              ...
              TextSpan(text:"\n cl :$cl"+""+" El :$el",style: TextStyle(color: Colors.red,fontSize: 22.0,fontFamily: "PermanentMarker")),
