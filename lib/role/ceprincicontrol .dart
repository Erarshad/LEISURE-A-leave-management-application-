...
class ced extends StatefulWidget {
  String myvar;
  ced({this.myvar});
  @override
  _cedState createState() => _cedState(myvar);
}

class _cedState extends State<ced> {
   String myvar;// faculty name 
  _cedState(this.myvar);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("C.E PANEL"),
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   //var firestore=Firestore.instance;
   QuerySnapshot qn= await firestore.collection('CE').where("Approved by Hod",isEqualTo:"yes").getDocuments();
   return qn.documents;  
