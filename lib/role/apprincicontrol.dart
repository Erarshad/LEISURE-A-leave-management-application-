...
class apd extends StatefulWidget {
  String myvar;
  apd({this.myvar});
  @override
  _apdState createState() => _apdState(myvar);
}

class _apdState extends State<apd> {
   String myvar;// faculty name 
  _apdState(this.myvar);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("A.s PANEL"),
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   //var firestore=Firestore.instance;
   QuerySnapshot qn= await firestore.collection('Applied Science').where("Approved by Hod",isEqualTo:"yes").getDocuments();
   return qn.documents;  
        ...
        Container(
           ...
           //Text("Application Submition Date: "+widget.post.data["Application submittion date"],style: TextStyle(fontSize: 25.0),),
            RichText(text:TextSpan(children:<TextSpan>[
              ...
              TextSpan(text:"\n C.L:$cl"+""+" E.L:$el",style: TextStyle(color: Colors.red,fontSize: 20.0)),
