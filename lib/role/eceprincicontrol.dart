...
class eced extends StatefulWidget {
  String myvar;
  eced({this.myvar});
  @override
  _ecedState createState() => _ecedState(myvar);
}

class _ecedState extends State<eced> {
   String myvar;// faculty name 
  _ecedState(this.myvar);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("E.C.E PANEL"),
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   //var firestore=Firestore.instance;
   QuerySnapshot qn= await firestore.collection('ECE').where("Approved by Hod",isEqualTo:"yes").getDocuments();
   return qn.documents;  
