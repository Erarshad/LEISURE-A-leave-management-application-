...
class med extends StatefulWidget {
  ...
  med({this.myvar});
  @override
  _medState createState() => _medState(myvar);
}

class _medState extends State<med> {
   String myvar;// faculty name 
  _medState(this.myvar);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("M.E PANEL"),
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   //var firestore=Firestore.instance;
   QuerySnapshot qn= await firestore.collection('ME').where("Approved by Hod",isEqualTo:"yes").getDocuments();
   return qn.documents;  
    ...
    return Scaffold(
      ...
      Column(children: <Widget>[
        ...
        RichText(text:TextSpan(children:<TextSpan>[
         ...
         RichText(text:TextSpan(children:<TextSpan>[
              TextSpan(text:"Arrangement request: ",style: TextStyle(color: Colors.blue,fontSize: 21.0)),
              TextSpan(text:widget.post.data["Arrangement request"],style: TextStyle(color: Colors.green,fontSize: 17.0)),
