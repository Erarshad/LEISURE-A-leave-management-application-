...
class ee extends StatefulWidget {
  ...
  ee({this.myvar});
  @override
  _eeState createState() => _eeState(myvar);
}
...
showNotification(Map<String, dynamic> msg) async {
  ...
  update(String token) {
    ...
    databaseReference.child('fcm-tokenee/${token}').set({"token": token});
    textValue = token;
    setState(() {});
  }
//-------
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   QuerySnapshot qn= await firestore.collection('EE').getDocuments();
   return qn.documents;  
  ...
  void rejected()
  {
     databasereference.collection("EE")
                      ...
                      .updateData({
                        ...
                        'HOD(ee)digital signature':"$myvar",
