...
class cs extends StatefulWidget {
  ...
  cs({this.myvar});
  @override
  _csState createState() => _csState(myvar);
}
...
showNotification(Map<String, dynamic> msg) async {
  ...
  update(String token) {
    ...
    databaseReference.child('fcm-tokencse/${token}').set({"token": token});
    textValue = token;
    setState(() {});
  }
//-------
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   QuerySnapshot qn= await firestore.collection('CSE').getDocuments();
   return qn.documents;  
   ...
   body:
    ...
    borderRadius: BorderRadius.circular(10),
          ...
          itemBuilder:(_,index){
            ...
            subtitle: Text(snapshot.data[index].data['Application submittion date']+"\n"+snapshot.data[index].data['Hod status'],style: TextStyle(fontFamily: "PatrickHand")),
