...
class me extends StatefulWidget {
  ...
  me({this.myvar});
  @override
  _meState createState() => _meState(myvar);
}
...
showNotification(Map<String, dynamic> msg) async {
  ...
  update(String token) {
    ...
    databaseReference.child('fcm-tokenme/${token}').set({"token": token});
    textValue = token;
    setState(() {});
  }
//-------
...
class _ListpageState extends State<Listpage> {
 ...
 async {
   ...
   QuerySnapshot qn= await firestore.collection('ME').getDocuments();
   return qn.documents;  
