...
void initState() {
 ...
 async {
   ...
   //var firestore=Firestore.instance;
   QuerySnapshot qn= await firestore.collection('$dept').where("Name",isEqualTo:"$name").getDocuments();
   return qn.documents;  
       ...
       if(snapshot.connectionState==ConnectionState.waiting){
        ...
        return
         Column(children: <Widget>[
          ...
          Card(child: 
          Text(" Dear $name check your" + " History ",style: TextStyle(fontSize: 20.0,fontFamily: "PermanentMarker"),),
...
class _detailpageState extends State<detailpage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("History of "+widget.post.data["Name"]),),
